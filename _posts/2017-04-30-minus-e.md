...
![Minus E - Closeup]({{ site.baseurl }}/media/{{ page.categories[0] }}/minus-e/minus-e.jpg) |
:----------: |
Minus E - Closeup |

<table style="width: 100%;">
  <thead><tr><th>
    <video controls width="100%" preload="auto" poster="{{ site.baseurl }}/media/{{ page.categories[0] }}/minus-e/minus-e-wwf-timelapse.jpg">
      <source src="{{ site.baseurl }}/media/{{ page.categories[0] }}/minus-e/minus-e-wwf-timelapse.mp4" type='video/mp4'>
    </video>
  </th></tr></thead>
...
![WWF - Monitor View]({{ site.baseurl }}/media/{{ page.categories[0] }}/minus-e/minus-e-wwf-monitor-view.jpg) | ![WWF]({{ site.baseurl }}/media/{{ page.categories[0] }}/minus-e/minus-e-wwf.jpg)
:----------: | :----------:
WWF - Monitor View | WWF, ink on paper, 176 x 176 cm (5.8 x 5.8 ft).

![Minus E - Maker Exhibition]({{ site.baseurl }}/media/{{ page.categories[0] }}/minus-e/minus-e-maker-exhibition.jpg) |
:----------: |
2017 \| Maker Exhibition, Innovation Space, Shanghai Library, Shanghai, China |

![Minus E - Life Geek Exhibition]({{ site.baseurl }}/media/{{ page.categories[0] }}/minus-e/minus-e-life-geek-exhibition.jpg) |
:----------: |
