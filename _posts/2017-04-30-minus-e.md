...
![Minus E instructed to draw a straight line](/media{{ page.url }}minus-e-instructed-to-draw-a-straight-line.jpg) | ![Minus E on its way to destination](/media{{ page.url }}minus-e-on-its-way-to-destination.jpg)
:----------: | :----------:
Minus E instructed to draw a straight line | Minus E on its way to destination

As is illustrated in the above pictures, the robot’s movement is far from precise. How do you create representational drawings without precise movements? My solution was to deconstruct the reference image into smaller units.
